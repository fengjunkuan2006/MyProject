            ...
            <div class="service-section-grid">
                ...
                <div class="icon-text">
                    ...
                    <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered
                        alteration in some form, by injected humouror randomised words which don't look even slightly
                        believable.</p>
                </div>
                <div class="clearfix"></div>
            </div>
...
<!--/services-->
<div class="copyrights">Collect from <a href="http://www.cssmoban.com/">ÍøÒ³Ä£°å</a></div>
<!--showcase-->
<div class="about-section">
    <div class="container">
        <div class="col-md-6 about_left">
            <img src="/staticmedia/images/aabout.jpg" alt=""/>
        </div>
        <div class="col-md-6 about_right">
            <h3>ABout us</h3>

            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                Lorem Ipsum has been the industry's standardtext of the printing and typeset
                ting industry. Lorem Ipsum has been the industry's standard dummy text ever
                since the 1500s, when an unknown printer took a galley of type and scrambled
                it to make a type specimen book. It has survived not only five centuries, b
                ut also the leap into electronic typesetting, remaining essentially unchange
                d. It was popularised in the ore recently with desktop publishing software li
            </p>
            <a href="/home/aboutPage">Read More</a>
        </div>
        <div class="clearfix"></div>
    </div>
</div>
